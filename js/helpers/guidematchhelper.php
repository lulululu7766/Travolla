...
$activityquery = $mysqli->query("SELECT name, home_city_id, image_path, gender, activity_level, mobility_level, dietary_restrictions FROM $table WHERE user_mode LIKE 'guide' AND home_city_id LIKE $cityid");
